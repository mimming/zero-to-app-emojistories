...
public class MainActivityComplete extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signOutButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                AuthUI.getInstance().signOut(MainActivityComplete.this);
            }
        });
        ...
        database.child("stories")
                ...
                .addChildEventListener(new ChildEventListener() {
                    public void onChildAdded(DataSnapshot snapshot, String s) {
                        displayStory(snapshot.getValue(Story.class), snapshot.getKey());
                    }
    ...
    private void toast(String message) {
        Toast.makeText(MainActivityComplete.this, message,

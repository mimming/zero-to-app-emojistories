...
class EmojistoriesViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIImagePickerControllerDelegate, UINavigationControllerDelegate, FUIAuthDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.database.reference(withPath: "emojis").queryLimited(toLast: 10).observe(.childAdded, with: { (snapshot) in
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let story = self.storiesArray[indexPath.item]["value"] as! [String: Any]
        
        cell.descriptionLabel.isHidden = true
        cell.pictureImageView.isHidden = true
        
        let emoji = story["emoji"] as! String
        
        for character in emoji.characters {
            cell.emojiLabel.text = String(character)
            break
        }
